module DCAProtocol
    ...
    function _dca_frequency_from_str(s::AbstractString)
        ...
        s == "Monthly"     ? DCAFrequency.Monthly     :
    ...
    function StructTypes.construct(::Type{DcaPlan}, obj::JSON3.Object)
        ...
        per_invest_amount = if isnothing(pia_raw) || (pia_raw isa AbstractString && isempty(pia_raw))
            Dec64(0)
