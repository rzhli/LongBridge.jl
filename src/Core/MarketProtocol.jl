module MarketProtocol
    ...
    export BrokerHoldingPeriod, AhPremiumPeriod,
           MarketTimeItem, MarketStatusResponse,
    ...
    function _broker_holding_period_str(p::BrokerHoldingPeriod.T)
        ...
        p === BrokerHoldingPeriod.Rct60 ? "rct_60" :
        error("unknown BrokerHoldingPeriod: $p")
    end
    ...
    function _ah_premium_period_line_type(p::AhPremiumPeriod.T)
        ...
        p === AhPremiumPeriod.Year  ? "4000" :
        error("unknown AhPremiumPeriod: $p")
    end
    ...
    function StructTypes.construct(::Type{TradeStatsResponse}, obj::JSON3.Object)
        ...
        TradeStatsResponse(
            StructTypes.construct(TradeStatistics, obj.statistics),
            trades,
        )
    end
