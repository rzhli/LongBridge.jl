module PortfolioProtocol
    ...
    export FlowDirection, AssetType,
           ...
           _flow_direction_from_str, _asset_type_from_str
    ...
    function StructTypes.construct(::Type{ProfitDetails}, obj::JSON3.Object)
        _entries(key) = if haskey(obj, key) && !isnothing(obj[key])
